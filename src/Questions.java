...
public class Questions {
	...
	// did everything in one class? that a good idea? Instructor feedback would be
	// appreciated
	 ...
	 int age;
	 String ageStr; // for quit option. convert to int after validation
	 boolean ageIsEven;
	 int ageConversionToRetirement; // for output

	 int birthMonth;
	 String birthMonthStr; // for quit option. convert to int after validation
	 int birthMonthConversionToBank; // for output

	 String favoriteColor;
	 String favoriteColorConversionToCar; // for output

	 int numberOfSiblings;
	 String numberOfSiblingsStr; // for quit option. convert to int after validation
	 String numberOfSiblingsConversionToLocation;
	...
	public void FortuneOutput() {
		System.out.println(firstName + " " + lastName + " will retire in " + ageConversionToRetirement + " years with $"
				+ birthMonthConversionToBank + ", a vacation home in " + numberOfSiblingsConversionToLocation
				+ ", and travel by " + favoriteColorConversionToCar + ".");
	}
